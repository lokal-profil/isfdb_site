...
def ISFDBTemplates():
        ...
        templates = {
                ...
                'Goodreads': ('http://www.goodreads.com/book/show/%s', 'Goodreads'),
...
def RecognizedDomains():
        ...
        domains = (
                ('1632.org', '1632, Inc.', 'https://www.1632.org', 1),
                ('amazon.ca', 'Amazon.ca', 'https://www.amazon.ca', 1),
                ('amazon.com', 'Amazon.com', 'https://www.amazon.com', 1),
                ('animenewsnetwork.com', 'Anime News Network', 'https://animenewsnetwork.com', 0),
                ('ansible.co.uk', 'Ansible', 'https://ansible.uk', 0),
                ('ansible.uk', 'Ansible', 'https://ansible.uk', 0),
                ('aozora.gr.jp', 'Aozora Bunko', 'https://www.aozora.gr.jp', 0),
                ('argee.net', 'Dr. Robert G. Williscroft', 'https://argee.net/', 1),
                ('armchairfiction.com', 'Armchair Fiction', 'https://www.armchairfiction.com', 1),
                ('asahi-net.or.jp', 'A. E. van Vogt Cover Art Gallery', 'https://www.asahi-net.or.jp/~we8y-mrt/vanvogt/', 1, '~we8y-mrt/vanvogt'),
                ('bestsf.net', 'Best SF', 'https://bestsf.net', 0),
                ('blogspot.com', 'Blogspot', 'https://www.blogger.com', 0),
                ('bnf.fr', 'National Library of France', 'https://www.bnf.fr', 0),
                ('bookscans.com', 'Bookscans', 'https://www.bookscans.com', 1),
                ('bookscans.fatcow.com', 'Bookscans', 'https://www.bookscans.com', 1),
                ('collectorshowcase.fr', 'Collectors Showcase', 'https://www.collectorshowcase.fr/intro.htm', 1),
                ('d-nb.info', 'German National Library', 'https://www.dnb.de/EN/Home/home_node.html', 0),
                ('daganbooks.com', 'Dagan Books', 'https://daganbooks.wordpress.com/', 1),
                ('dbr.nu', 'Diamond Bay Research', 'https://dbr.nu', 1),
                ('deboekenplank.nl', 'De Boekenplank', 'https://www.deboekenplank.nl/index.htm', 1),
                ('downwarden.com', 'Black Bed Sheet Books', 'https://www.downwarden.com', 1),
                ('dwtr67e3ikfml.cloudfront.net', 'Smashwords', 'https://www.smashwords.com', 1, '', 1),
                ('encyklopediafantastyki.pl', 'Encyklopedia Fantastyki', 'http://www.encyklopediafantastyki.pl', 0),
                ('ericflint.net', '1632, Inc.', 'https://www.1632.org', 1),
                ('facebook.com', 'Facebook', 'https://www.facebook.com', 0),
                ('fancyclopedia.org', 'Fancyclopedia 3', 'https://www.fancyclopedia.org', 0),
                ('fantascienza.com', 'Fantascienza', 'https://fantascienza.com', 1),
                ('fantasticfiction.co.uk', 'Fantastic Fiction', 'https://fantasticfiction.com', 1),
                ('fantasticfiction.com', 'Fantastic Fiction', 'https://fantasticfiction.com', 1),
                ('fantlab.ru', 'FantLab', 'https://fantlab.ru', 1),
                ('goodreads.com', 'Goodreads', 'https://goodreads.com', 0),
                ('grantvillegazette.com', '1632, Inc.', 'https://www.1632.org', 1),
                ('gutenberg.org', 'Gutenberg', 'https://gutenberg.org', 0),
                ('howardworks.com', 'Howard Works', 'https://howardworks.com', 1),
                ('icshi.net', 'The Weird Worlds of A. E. van Vogt', 'https://www.icshi.net/worlds/', 1),
                ('images-amazon.com', 'Amazon.com', 'https://www.amazon.com', 1),
                ('images-eu.amazon.com', 'Amazon UK', 'https://www.amazon.co.uk', 1),
                ('imdb.com', 'IMDB', 'https://www.imdb.com', 0),
                ('instagram.com', 'Instagram', 'https://www.instagram.com', 0),
                ('isfdb.org', 'ISFDB', '%s://www.isfdb.org' % PROTOCOL, 1),
                ('jeddicon.com', 'JeddiCon', 'https://jeddicon.com', 1),
                ('jenniferrpovey.com', 'Jennifer R. Povey', 'https://www.jenniferrpovey.com', 1),
                ('kirjasto.sci.fi', 'Books and Writers', 'https://kirjasto.sci.fi', 0),
                ('librarything.com', 'LibraryThing', 'https://www.librarything.com', 0),
                ('linkedin.com', 'LinkedIn', 'https://www.linkedin.com', 0),
                ('livejournal.com', 'LiveJournal', 'https://www.livejournal.com', 0),
                ('lndb.info', 'Light Novel Database', 'http://lndb.info', 0),
                ('loc.gov', 'Library of Congress', 'https://www.loc.gov', 0),
                ('locusmag.com', 'Locus', 'https://locusmag.com', 0),
                ('luminist.org', 'The Luminist League', 'https://www.luminist.org', 1),
                ('media-amazon.com', 'Amazon.com', 'https://www.amazon.com', 1),
                ('metaphorosis.com', 'Metaphorosis', 'https://www.metaphorosis.com', 1),
                ('mondourania.com', 'Mondourania', 'http://www.mondourania.com', 1),
                ('myanimelist.net', 'MyAnimeList', 'https://myanimelist.net', 0),
                ('myspace.com', 'Myspace', 'https://myspace.com', 0),
                ('nasa.gov', 'NASA', 'https://www.nasa.gov', 0),
                ('nathanmhurst.com', 'Nathan M Hurst', 'https://nathanmhurst.com', 1),
                ('nla.gov.au', 'National Library of Australia', 'https://www.nla.gov.au', 0),
                ('ofearna.us', 'Susan O\'Fearna', 'https://ofearna.us', 1),
                ('openlibrary.org', 'Open Library', 'https://openlibrary.org', 1),
                ('people.uncw.edu', 'Ace Image library', 'http://people.uncw.edu/smithms/ACE.html', 1),
                ('philsp.com', 'Galactic Central', 'http://philsp.com', 1),
                ('pinterest.com', 'Pinterest', 'https://www.pinterest.com', 0),
                ('plus.google.com', 'Google+', 'https://plus.google.com', 0),
                ('pulpcovers.com', 'PulpCovers.com', 'https://pulpcovers.com', 1),
                ('relativitybirthdaypresent.com', 'Dr. Robert G. Williscroft', 'http://relativitybirthdaypresent.com', 1),
                ('riversofwar.com', '1632, Inc.', 'https://www.1632.org', 1),
                ('rusf.ru', 'Russian SF&F', 'https://rusf.ru', 0),
                ('scifiinc.net', 'Fan Gallery', 'http://www.scifiinc.org/', 0),
                ('sf-encyclopedia.com', 'SFE', 'https://www.sf-encyclopedia.com', 1, 'gal/', 1),
                ('sf-encyclopedia.uk', 'SFE', 'https://www.sf-encyclopedia.com', 1, 'gal/', 1),
                ('sf-encyclopedia.uk', 'Encyclopedia of Fantasy', 'http://sf-encyclopedia.uk/fe/', 1, 'fe.php'),
                ('sf-leihbuch.de', 'SF-Leihbuch', 'http://www.sf-leihbuch.de/index.cfm?page=home', 1, '', 1),
                ('sfadb.com', 'Science Fiction Awards Database', 'https://sfadb.com', 0),
                ('sff.net', 'SFF Net', 'http://sff.net', 0),
                ('sfsite.com', 'SF Site', 'https://www.sfsite.com', 0),
                ('sfwa.org', 'SFWA', 'https://www.sfwa.org', 0),
                ('shelfari.com', 'Shelfari', 'http://shelfari.com', 0),
                ('sinistercinema.com', 'Armchair Fiction', 'https://www.armchairfiction.com', 1),
                ('slingshotnovel.com', 'Dr. Robert G. Williscroft', 'http://slingshotnovel.com', 1),
                ('ssl-images-amazon.com', 'Amazon.com', 'https://www.amazon.com', 1),
                ('starchildcompact.com', 'Dr. Robert G. Williscroft', 'http://starchildcompact.com', 1),
                ('thetrashcollector.com', 'The Trash Collector', 'https://www.thetrashcollector.com', 1),
                ('thrawnrickle.com', 'Dr. Robert G. Williscroft', 'https://thrawnrickle.com', 1),
                ('tumblr.com', 'Tumblr', 'https://www.tumblr.com', 0),
                ('twitter.com', 'Twitter', 'https://www.twitter.com', 0),
                ('uraniamania.com', 'Urania Mania', 'https://www.uraniamania.com', 1),
                ('vectoreditors.files.wordpress.com', 'Vector', 'https://vector-bsfa.com', 1),
                ('vonniewinslowcrist.files.wordpress.com', 'Vonnie Winslow Crist', 'https://vonniewinslowcrist.wordpress.com', 1),
                ('wattpad.com', 'Wattpad', 'https://www.wattpad.com', 0),
                ('wikipedia.org', 'Wikipedia', 'https://www.wikipedia.org', 0),
                ('wordpress.com', 'WordPress', 'https://www.wordpress.com', 0),
                ('worldcat.org', 'WorldCat', 'https://www.worldcat.org', 0),
                ('wp.com', 'Nitchevo Factory', 'https://nitchevo.net', 1, 'nitchevo.net'),
                ('youtube.com', 'YouTube', 'https://www.youtube.com', 0),
                ('yunchtime.net', 'Diamond Bay Research', 'https://yunchtime.net', 1),
         )
        return domains
