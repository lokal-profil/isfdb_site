...
def function100():
	query = """select distinct p.pub_id, p.pub_title, p.pub_price
                ...
                or (p.pub_price regexp '[.]{1}[[:digit:]]{3,}' and p.pub_price not like 'BD %')
...
def function243():
        cleanup.query = """select p.pub_id, p.pub_title
                ...
                or
                p.pub_frontimage REGEXP '\.ssl-images-amazon\.com/images/S/amzn-author-media-prod/[0-9a-z]{26}\.(gif|png|jpg)$')
                order by p.pub_title"""
