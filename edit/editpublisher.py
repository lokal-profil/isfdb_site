#!_PYTHONLOC
#
#     (C) COPYRIGHT 2004-2016   Al von Ruff and Ahasuerus
#         ALL RIGHTS RESERVED
#
...
if __name__ == '__main__':
	...
	print '<form id="data" METHOD="POST" ACTION="/cgi-bin/edit/submitpublisher.cgi" onsubmit="return validatePublisherForm()">'
	...
	printfield("Publisher Name", "publisher_name", help, record[PUBLISHER_NAME], display_only)
        ...
        printmultiple(trans_publisher_names, "Transliterated Name", "trans_publisher_names",
                      ...
                      "'%s', '%s', '%s'" % ('AddTransName', 'Transliterated Name', 'trans_publisher_names'))
