...
if __name__ == '__main__':
	...
	PrintPreMod('Proposed Award Type Delete Submission')
	PrintNavBar()
	...
	submitter = DisplayAwardTypeDelete(submission_id)
	...
	ApproveOrReject('award_type_delete_file.cgi', submission_id)
	PrintPostMod()
