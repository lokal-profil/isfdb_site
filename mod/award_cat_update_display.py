...
if __name__ == '__main__':
	...
	PrintPreMod('Proposed Award Category Update Submission')
	PrintNavBar()
	...
	submitter = DisplayAwardCatChanges(submission_id)
	...
	ApproveOrReject('award_cat_update_file.cgi', submission_id)
	PrintPostMod()
