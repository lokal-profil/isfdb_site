...
if __name__ == '__main__':
	...
	PrintPreMod('Proposed Award Category Delete Submission')
	PrintNavBar()
	...
	submitter = DisplayAwardCatDelete(submission_id)
	...
	ApproveOrReject('award_cat_delete_file.cgi', submission_id)
	PrintPostMod()
