...
for reference in references:
        ...
        if ver_status == 0:
                ...
                print '<td><input type="radio" value="VER" name="xx%d" class="nodisplay"><a href="%s://%s/index.php/User:%s">%s</a></td>' % (ref_id, PROTOCOL, WIKILOC, verifier_name, verifier_name)
                ...
                print '<td><input type="radio" value="NOTVER" name="xx%d"></td>' % ref_id
                print '<td><input type="radio" value="VER" name="xx%d"></td>' % ref_id
                print '<td><input type="radio" value="NA" name="xx%d" class="nodisplay"><a href="%s://%s/index.php/User:%s">%s</a></td>' % (ref_id, PROTOCOL, WIKILOC, verifier_name, verifier_name)
        print '</tr>'
print '</table>'
print '<p>'
