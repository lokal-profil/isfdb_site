		...
		for pub in pubs:
			...
			if pub[PUB_YEAR] == '0000-00-00':
				...
				nonefound = 0
                        ...
                        # If the book has an ISBN/catalog ID or is an e-book, magazine
                        # or fanzine, then we are OK
			if pub[PUB_ISBN] or (pub[PUB_PTYPE] == 'ebook') or (pub[PUB_CTYPE] in ('MAGAZINE', 'FANZINE')):
				pass
			elif year_num > 1950:
